    ...
    fileprivate func rearrangeViews() {
        ...
        for (index, tagView) in tagViews.enumerated() {
            ...
            if currentRowTagCount == 0 || currentRowWidth + tagView.frame.width > frame.width {
                ...
                //                    self.frame = CGRect(x: self.frame.origin.x, y: self.frame.origin.y, width: self.frame.width, height: self.frame.height+(CGFloat(20*currentRow)))
                //                }
                ...
                self.frame = CGRect(x: self.frame.origin.x, y: self.frame.origin.y, width: self.frame.width, height: (CGFloat(20*(currentRow))))
            }
